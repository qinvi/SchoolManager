<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StaffQuery.aspx.cs" Inherits="Teacher_StaffQuery" %>
                ...
                <tr>
                    <td colspan="3" style="background-image: url(Images/main_top_bg.gif); width: 929px; height: 13px">
                        <asp:Image ID="Image1" runat="server" Height="14px" ImageUrl="~/Student/Images/main_top_1.gif"
                            Width="14px" />
                        教研室查询<asp:Label ID="lblTitle" runat="server" Text="" Width="658px"></asp:Label></td>
                </tr>
                <tr>
                                    ...
                                    <asp:GridView ID="gv_ScoreTable" runat="server" AutoGenerateColumns="False"  CellPadding="4"
                                        ...
                                        <Columns>
                                           <%-- <asp:BoundField DataField="cb_id" HeaderText="课程代码" />
                                            ...
                                            <asp:BoundField DataField="室号" HeaderText="室号" /> 
                                            <asp:BoundField DataField="名称" HeaderText="教研室名称" />
                                            <asp:BoundField DataField="工号" HeaderText="教师工号" /> 
                                            <asp:BoundField DataField="姓名" HeaderText="教师姓名" />   
                                            <asp:BoundField DataField="课程名" HeaderText="担任课程" />      
                                            <asp:BoundField DataField="联系方式" HeaderText="教师联系方式" />
                                            <asp:BoundField DataField="办公电话" HeaderText="教研室办公电话" />
