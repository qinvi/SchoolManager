...
public partial class Student_CourseTable : System.Web.UI.Page
{
    ...
    protected void CourseTable_Click(object sender, EventArgs e)
    {
        string UserName = Session["UserName"].ToString();  //获得登录界面的账号
        ...
        string sql = "select 室号,课程名,星期,时间 from 教室,课程,选课 where 选课.学号 = '"+UserName+"' and 选课.课程号 = 课程.课程号 and 选课.课程号 = 教室.课程号";
